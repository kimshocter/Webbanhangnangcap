package com.eshop.store.store.controller;
...
import com.eshop.store.store.domain.ArticleBuilder;
import com.eshop.store.store.domain.Brand;
import com.eshop.store.store.domain.Category;
import com.eshop.store.store.domain.Size;
import com.eshop.store.store.service.ArticleService;
